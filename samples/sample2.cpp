...
int main() {
    ...
    int stride[][2] = {{1, 1}, {2, 1}, {1, 1}, {2, 3}, {1, 1}, {1, 1}, {2, 3}, {1, 1}, {2, 4}, {2, 4}};
    int dilation[][2] = {{1, 1}, {1, 1}, {3, 2}, {3, 2}, {1, 1}, {1, 1}, {3, 2}, {3, 2}, {2, 2}, {2,2}};
    int padding[][2] ={{0, 0}, {0, 0}, {0, 0}, {0, 0}, {1, 2}, {0, 0}, {3, 4}, {0, 0}, {5, 4}, {5, 4}};
    ...
    int out_channels[] = {1, 1, 1, 1, 1, 1, 1, 1, 1, 5};
